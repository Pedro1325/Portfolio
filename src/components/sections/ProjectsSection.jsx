...
const projectsData = [
  ...
  },
  {
    ...
    description: "Versão anterior do meu portfólio pessoal, focada em design minimalista.",
  ...
  },
  {
    ...
    description: "Aplicação para gerenciamento de tarefas com drag-and-drop e colaboração.",
    technologies: ["React.js", "TypeScript", "Material UI", "Firebase"],
